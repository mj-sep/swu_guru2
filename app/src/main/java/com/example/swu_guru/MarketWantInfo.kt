...
class MarketWantInfo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_market_want_info)
        ...
        //cursor로 해당 타이틀을 가진 db 불러오기

        var cursor : Cursor
        cursor = sqlitedb.rawQuery("SELECT * FROM marketWantTBL WHERE title='"+str_title+"';", null)
